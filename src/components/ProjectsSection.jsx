...
const projects = [
  {
    ...
    image: "/projects/netfliximg.png",
    tags: ["Html", "Css", "Personal Project"],
    demoUrl: "/public/projects/netflix/index.html",
  ...
  return (
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        ...
        Here are some of my recent university and personal projects, each carefully crafted with a focus on detail, performance, and user experience.  </p>
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://github.com/theblondedev"
          >
